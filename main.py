...
def genbookid():
	if request.method == "POST":
		genbookid = generate_sequential_id("BOTANIBOOKID_")
...
######################################################################################################################## SHEET RELATED
def insert_to_sheet():
	C_UniqueID = generate_sequential_id("BOTANIID_")
...
def submit_form(C_UniqueID):
	...
	form_docx_path = "reform/BOTANI_Form.docx"  # Path to the first document
